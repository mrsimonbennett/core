...
use FullRent\Core\Tenancy\Commands\AmendScheduledTenancyRentPaymentHandler;
 ...
 */
final class ChangeScheduledPaymentTest extends \Specification
{
    /**
     * @var string
     */
    ...
    {
        return new AmendScheduledTenancyRentPayment($this->tenancyId,
                                                    $this->paymentId,
                                                    '100',
    ...
    {
        return new AmendScheduledTenancyRentPaymentHandler($repository);
    }
