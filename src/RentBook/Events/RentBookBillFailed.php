 ...
 */
final class RentBookBillFailed implements Serializable, \SmoothPhp\Contracts\EventSourcing\Event
{
    /** @var RentBookId */
    private $id;
    ...
    public static function deserialize(array $data)
    {
        return new static(new RentBookId($data['rent_book_id']),
                          ...
                          DateTime::deserialize($data['failed_at']));
    }
    ...
    public function serialize()
    {
        return [
            ...
            'failed_at'   => $this->acknowledgedAt->serialize()
        ];
    }
