...
/**
 * Class RentBookBillFailed
 * @package FullRent\Core\RentBook\Events
 * @author Simon Bennett <simon@bennett.im>
 */
final class RentBookBillWithdrawn implements Serializable, \SmoothPhp\Contracts\EventSourcing\Event
{
    /** @var RentBookId */
    private $id;
    ...
    public function __construct(RentBookId $id, $billId, RentBookRentId $rentBookRentId, DateTime $acknowledgedAt)
    {
        $this->id = $id;
        $this->billId = $billId;
        $this->withdrawnAt = $acknowledgedAt;
    ...
    public static function deserialize(array $data)
    {
        return new static(new RentBookId($data['rent_book_id']),
                          ...
                          DateTime::deserialize($data['withdrawn_at']));
    }
    ...
    public function serialize()
    {
        return [
            ...
            'withdrawn_at'   => $this->withdrawnAt->serialize()
        ];
    }
