 ...
 */
final class RentBookBillCancelled implements Serializable, \SmoothPhp\Contracts\EventSourcing\Event
{
    /** @var RentBookId */
    private $id;
    ...
    public static function deserialize(array $data)
    {
        return new static(new RentBookId($data['rent_book_id']),
                          ...
                          DateTime::deserialize($data['cancelled_at']));
    }
    ...
    public function serialize()
    {
        return [
            ...
            'cancelled_at'   => $this->acknowledgedAt->serialize()
        ];
    }
